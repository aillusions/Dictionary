...
public class TopEditor extends JFrame
{
  ...
  private void initComponents()
  {
    ...
    this.jChBoxPlayOnSelections.setToolTipText("Play record by selection in navigator");
    ...
    this.selectNextRandomBtn.addMouseListener(new MouseAdapter()
    {
      public void mouseReleased(MouseEvent paramMouseEvent)
      {
        TopEditor.this.selectNextRandomBtnMouseReleased(paramMouseEvent);
      }
    });
    ...
    Object localObject = new ListSelectionListener()
    {
      ...
      {
        if ((paramListSelectionEvent.getValueIsAdjusting()) || ((!(TopEditor.this.InUseJList.isFocusOwner())) && (!(TopEditor.this.selectNextRandomBtn.isFocusOwner()))))
          return;
        TopEditor.this.WordsList_Lst.setSelectedValue(TopEditor.this.InUseJList.getSelectedValue(), true);
      }
    };
    this.InUseJList.addListSelectionListener((ListSelectionListener)localObject);
    ...
    localObject = new ListSelectionListener()
    {
      public void valueChanged(ListSelectionEvent paramListSelectionEvent)
      {
        if (paramListSelectionEvent.getValueIsAdjusting())
          return;
        if ((TopEditor.this.dictionary.getCurrentPair() != null) && (!(TopEditor.this.dictionary.aplyCurrWordChanged(TopEditor.this.Translate_TextF.getText(), TopEditor.this.Transcription_TextF.getText()))))
          TopEditor.this.Alert("Your input was not aplyed!");
        if (TopEditor.this.dictionary.setSelected((String)TopEditor.this.WordsList_Lst.getSelectedValue()))
        {
    ...
    this.WordsList_Lst.addListSelectionListener((ListSelectionListener)localObject);
    ...
    localObject = new ListSelectionListener()
    {
      public void valueChanged(ListSelectionEvent paramListSelectionEvent)
      {
        ...
        if (TopEditor.this.jListSamples.getSelectedIndex() == -1)
          ...
          TopEditor.this.dictionary.setCurrSample(TopEditor.this.jListSamples.getSelectedValue().toString());
        if ((!(TopEditor.this.jChBoxPlayOnSelections.isSelected())) || (TopEditor.this.jListSamples.getSelectedIndex() == -1))
          return;
        TopEditor.this.dictionary.playCurrentAudioRecord(true, false);
      }
    };
    this.jListSamples.addListSelectionListener((ListSelectionListener)localObject);
  ...
  {
    if (this.dictionary.aplyCurrWordChanged(this.Translate_TextF.getText(), this.Transcription_TextF.getText()))
      return;
  ...
  private void literalButtonsMouseReleased(MouseEvent paramMouseEvent)
  {
    ...
    {
      this.Transcription_TextF.setText(this.dictionary.getCurrentPair().getTranscription() + ((JButton)paramMouseEvent.getSource()).getText());
      if (this.dictionary.aplyCurrWordChanged(this.Translate_TextF.getText(), this.Transcription_TextF.getText()))
        return;
      Alert("Your input was not aplyed!");
    }
  ...
  private void refresh(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    {
      setTitle("Top Dictionary - " + (this.WordsList_Lst.getSelectedIndex() + 1) + " : " + new Integer(this.dictionary.getAllWords().length).toString());
      this.Word_TextF.setText(this.dictionary.getCurrentPair().getEnglish());
      this.Translate_TextF.setText(this.dictionary.getCurrentPair().getRussian());
      this.Transcription_TextF.setText(this.dictionary.getCurrentPair().getTranscription());
      if (paramBoolean2)
      {
        str = null;
        ...
        if (this.dictionary.getCurrentPair().getSamples() != null)
          this.jListSamples.setListData(this.dictionary.getCurrentPair().getSamples());
        else
          this.jListSamples.setListData(new String[0]);
        if (this.dictionary.getCurrentPair().getSamples() != null)
    ...
    if (paramBoolean1)
    {
      ...
      this.WordsList_Lst.setListData(this.dictionary.getAllWords());
      if ((this.dictionary.setSelected(str)) && (this.dictionary.getCurrentPair() != null))
        this.WordsList_Lst.setSelectedValue(this.dictionary.getCurrentPair().getEnglish(), true);
    }
    if (this.dictionary.getCurrentPair() == null)
      if (this.dictionary.getAllWords().length > 0)
        this.WordsList_Lst.setSelectedValue(this.dictionary.getAllWords()[0], true);
      else
  ...
  private void jTxtSearchKeyReleased(KeyEvent paramKeyEvent)
  {
    ...
    else
    {
      if (str.equals(""))
        return;
      for (int i = this.prevSelectedIndex + 1; i < this.dictionary.getAllWords().length; ++i)
      {
        if (this.dictionary.getAllWords()[i].indexOf(str) == 0)
        {
          this.WordsList_Lst.setSelectedValue(this.dictionary.getAllWords()[i], true);
  ...
  private void jButtAddSampleMouseReleased(MouseEvent paramMouseEvent)
  {
    ...
    else if (this.dictionary.addNewSample(this.jTextSamplesSearch.getText()))
  ...
  private void jTextSamplesSearchKeyReleased(KeyEvent paramKeyEvent)
  {
    if (paramKeyEvent.getKeyCode() != 10)
      return;
    if ((!(this.jTextSamplesSearch.getText().equals(""))) && (this.dictionary.addNewSample(this.jTextSamplesSearch.getText())))
      this.jTextSamplesSearch.setText("");
    refresh(false, true);
  }
  ...
  {
    this.dictionary.setCurrSample((String)this.jListSamples.getSelectedValue());
    refresh(false, false);
  }
  ...
  {
    if ((paramKeyEvent.getKeyCode() == 155) && (this.WordsList_Lst.getSelectedIndex() < this.dictionary.getAllWords().length))
    {
      this.dictionary.getCurrentPair().setInuse(true);
      this.WordsList_Lst.setSelectedIndex(this.WordsList_Lst.getSelectedIndex() + 1);
    }
    if ((paramKeyEvent.getKeyCode() != 127) || (this.WordsList_Lst.getSelectedIndex() >= this.dictionary.getAllWords().length))
      return;
  ...
  {
    this.WordsList_Lst.setSelectedValue(this.InUseJList.getSelectedValue(), true);
  }
  ...
  private void inUseListRefresh()
  {
    ...
    if (i < this.dictionary.getAllInUseWords().length)
      ...
      this.InUseJList.setSelectedIndex(this.dictionary.getAllInUseWords().length - 1);
  }
  ...
  {
    String str = this.dictionary.getAllInUseWords()[this.nextSelRandom.nextInt(this.dictionary.getAllInUsePairs().length)];
...
/* Location:           E:\ATG\workspace\Dictionary.jar
 * Qualified Name:     com.myjavaserver.aillusions.view.TopEditor
