 ...
 */
public class DownloadUpdateDialog extends javax.swing.JFrame {
	...
	private void viewRefresh() {
...

		{
			getContentPane().add(
					TRANSCR,
					new AnchorConstraint(57, 768, 149, 500,
							...
							AnchorConstraint.ANCHOR_REL));
			{
				getContentPane().add(
						optionsList,
						new AnchorConstraint(185, 981, 960, 24,
								AnchorConstraint.ANCHOR_REL,
								AnchorConstraint.ANCHOR_REL,
								AnchorConstraint.ANCHOR_REL,
								AnchorConstraint.ANCHOR_REL));
	...
	public void frameConstructor() {
		...
		getContentPane().setLayout(thisLayout);
		{
			...
			getContentPane().add(
					ClearResultsBtn,
					new AnchorConstraint(45, 979, 155, 804,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL));
		...
		}
		{
			...
			getContentPane().add(
					quastionLable,
					new AnchorConstraint(57, 489, 149, 31,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL,
							AnchorConstraint.ANCHOR_REL));
