  ...
  implements TrainerViewListener
{
  ...
  private String[] getVariants()
  {
    ...
    for (int i1 = 0; i1 < i; ++i1)
      if (i1 != j)
      {
        ...
        if (this.isEngRus)
          localArrayList.add(this.dictionary.getAllPairs()[i2].getRussian());
        else
          localArrayList.add(this.dictionary.getAllPairs()[i2].getEnglish());
      }
  ...
  public boolean onChuseAnsversVariant(String paramString)
  {
    ...
    if (this.isEngRus)
    {
      if ((this.currentPair.getRussian().equalsIgnoreCase(paramString)) || (paramString.equals("empty")))
      {
        this.currentPair.incrRightAnswerQuantity();
        return true;
      }
    }
    else if ((this.currentPair.getEnglish().equalsIgnoreCase(paramString)) || (paramString.equals("empty")))
    {
      this.currentPair.incrRightAnswerQuantity();
      return true;
    }
  ...
  void showQuestion()
  {
    ...
    else
    {
      ...
      if (this.isEngRus)
        this.view.setPairtForQuastion(this.currentPair.getEnglish(), this.currentPair.getTranscription(), getVariants());
      else
        this.view.setPairtForQuastion(this.currentPair.getRussian(), "", getVariants());
    }
  }
 ...
 * Qualified Name:     com.myjavaserver.aillusions.Trainer
